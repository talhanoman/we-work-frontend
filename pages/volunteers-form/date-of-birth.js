          ...
          <div className="space-y-6">
              ...
              <div className="max-w-[180px] w-full space-y-1.5">
                ...
                <div className="relative">
                  <DatePicker
                    ...
                    className={`w-full h-11 block text-gray-900 text-sm-regular 2xl:text-md-regular rounded-lg border ${isBelow18 ? "border-error-300" : "border-gray-300"
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              ...
              <button
                ...
                onClick={() => router.push("/volunteers-form/profile-photo")}
              >
                Continue
              </button>
            </div>
