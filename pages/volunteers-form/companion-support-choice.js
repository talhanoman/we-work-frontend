...
export default function CompanionSupportChoice() {
        ...
        <div className="w-full h-screen max-w-[512px] mx-auto flex flex-col justify-center gap-y-8">
          <div className="space-y-3">
            <h1 className="text-display-xs-semibold 2xl:text-display-sm-semibold text-gray-900">
              Do you require the{" "}
              <span className="text-primary-700">support</span>{" "}
              of a companion?
            </h1>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              <button
                ...
                onClick={() => router.push("/volunteers-form/volunteer-experience-choice")}
              >
                Yes
              </button>
              <button
