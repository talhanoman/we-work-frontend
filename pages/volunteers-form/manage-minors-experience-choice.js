...
export default function ManageMinorsExperienceChoice() {
  ...
  return (
    <div className="flex h-screen bg-white justify-center">
      ...
      <div className="relative w-8/12 flex flex-col bg-white">
        ...
        />
        {/* Manage Minors Experience Choice */}
        <div className="w-full h-screen max-w-[512px] mx-auto flex flex-col justify-center gap-y-8">
          <div className="space-y-3">
            <h1 className="text-display-xs-semibold 2xl:text-display-sm-semibold text-gray-900">
              Do you any experience working with{" "}
              <span className="text-primary-700">young people</span> (under 16)?
            </h1>
            <p className="text-sm-regular 2xl:text-md-regular text-gray-700">
              Some of our events involve working with children and teenagers.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              <button className="w-full h-11 flex justify-center items-center flex-1 order-2 sm:order-1 text-sm-semibold 2xl:text-md-semibold border border-gray-300 bg-white rounded-lg text-gray-700 py-2.5 shadow-xs"
                onClick={() => router.push("/volunteers-form/manage-minors-experience-details")}
              >
                Yes
              </button>
              <button className="w-full h-11 flex justify-center items-center flex-1 order-2 sm:order-1 text-sm-semibold 2xl:text-md-semibold border border-gray-300 bg-white rounded-lg text-gray-700 py-2.5 shadow-xs"
