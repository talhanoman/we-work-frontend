...
export default function VolunteerExperienceChoice() {
        ...
        <div className="w-full h-screen max-w-[512px] mx-auto flex flex-col justify-center gap-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm-regular 2xl:text-md-regular text-gray-700">
              Don't worry if you haven't - we're happy to work with volunteers of all experience levels!
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              <button
                ...
                onClick={() => router.push("/volunteers-form/experience-details")}
              >
                Yes
              </button>
              <button
