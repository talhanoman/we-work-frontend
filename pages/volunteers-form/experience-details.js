...
export default function ExperienceDetails() {
  ...
  const handleInputChange = (event) => {
    ...
    setFormData({
      ...
      experienceDetailsValid: value.length >= 1,
    });
  };
        ...
        <div className="w-full h-screen max-w-[512px] mx-auto flex flex-col justify-center gap-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm-regular 2xl:text-md-regular text-gray-700">
              We'd love to hear about the impact you've made and the skills you've gained.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <form action="">
              ...
              >
                Experience Details<span className="text-primary-600">*</span>
              </label>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              ...
              <button
                ...
                disabled={!(formData.experienceDetailsValid)}
                onClick={() => router.push("/volunteers-form/mega-event-experience-choice")}
              >
                Continue
              </button>
            </div>
