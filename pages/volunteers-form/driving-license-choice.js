...
export default function DrivingLicenseChoice() {
        ...
        <div className="w-full h-screen max-w-[512px] mx-auto flex flex-col justify-center gap-y-8">
          <div className="space-y-3">
            <h1 className="text-display-xs-semibold 2xl:text-display-sm-semibold text-gray-900">
              Do you have a valid{" "}
              <span className="text-primary-700">driving license</span>?
            </h1>
            <p className="text-sm-regular 2xl:text-md-regular text-gray-700">
              We may have volunteer opportunities that require driving, so please let us know if you have a valid license.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              <button
                ...
                onClick={() => router.push("/volunteers-form/transport")}
              >
                Yes
              </button>
              <button
