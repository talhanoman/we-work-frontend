...
export default function MegaEventExperienceChoice() {
        ...
        <div className="w-full h-screen max-w-[512px] mx-auto flex flex-col justify-center gap-y-8">
          <div className="space-y-3">
            <h1 className="text-display-xs-semibold 2xl:text-display-sm-semibold text-gray-900">
              ...
              <span className="text-primary-700">mega events</span>{" "}
              before?
            </h1>
            <p className="text-sm-regular 2xl:text-md-regular text-gray-700">
              We value all levels of volunteering experience and appreciate the skills and knowledge gained from previous opportunities.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
              <button
                ...
                onClick={() => router.push("/volunteers-form/mega-event-experience-details")}
              >
                Yes
              </button>
              <button
