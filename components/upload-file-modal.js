...
const card_type = [{ value: 'ID' }, { value: 'Passport' }];
...
export default function UploadFileModal({
  ...
  const [cardType, setCardType] = useState(card_type[0]);
                ...
                <Dialog.Panel className='w-full max-w-[480px] transform overflow-hidden rounded-xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  <div className='space-y-8'>
                    <div className='space-y-5'>
                      ...
                      <div className='space-y-4'>
                        ...
                        <div
                          ...
                          onClick={() =>
                            document.getElementById('upload_option').click()
                          }
                    ...
                    <div className='flex justify-between gap-3'>
                      <button
                        className='flex-1 text-md-semibold border border-gray-300 bg-white rounded-lg text-gray-700 py-2.5'
                        onClick={closeModal}
                      >
                        Cancel
                      </button>
                      <button
                        className='flex-1 text-md-semibold border border-primary-600 bg-primary-600 rounded-lg text-white py-2.5 disabled:opacity-75 disabled:pointer-events-none'
